            ...
            <div class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
              <div>
                ...
                <p class="mt-8 text-base text-black sm:text-xl">
                  ...
                  inspiration. Whether you're exploring new ideas, staying
                  updated on trends, spark conversations, and celebrate the art
                  of storytelling. Dive in and let your curiosity lead the way!
                </p>
                ...
                <div class="mt-10 sm:flex sm:items-center sm:space-x-8">
                  <a
                    href="#"
                    title=""
                    class="inline-flex items-center justify-center px-10 py-4 text-base font-semibold text-white transition-all duration-200 bg-orange-500 hover:bg-orange-600 focus:bg-orange-600 rounded-lg"
                    role="button"
                  >
                    {" "}
                    Start exploring{" "}
